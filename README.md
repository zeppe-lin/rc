...
- added cryptmount(8) to parse crypttab(5) files and map encrypted volumes
...
- mkfontdir(1) and mkfontscale(1) from xorg's mkfontscale distribution to
  create an index of font files for xorg package
- fc-cache(1) from fontconfig distribution to build font information cache
  files
